...
import net.engine.resourceHandlers.tiles.floor.ChairImageHandler;


public class ChairTile extends Tile{
	ChairImageHandler chairTileImageHandler = new ChairImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return chairTileImageHandler.returnImage();
	}
