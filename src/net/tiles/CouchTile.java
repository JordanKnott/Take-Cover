...
import net.engine.resourceHandlers.tiles.floor.CouchImageHandler;


public class CouchTile extends Tile{
	CouchImageHandler couchImageHandler = new CouchImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return couchImageHandler.returnImage();
	}
