...
import net.engine.resourceHandlers.tiles.floor.LighterBlueCarImageHandler;


public class LightBlueCarTile extends Tile{
	LighterBlueCarImageHandler concreteTileImageHandler = new LighterBlueCarImageHandler();
