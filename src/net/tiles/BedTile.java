...
import net.engine.resourceHandlers.tiles.floor.BedImageHandler;


public class BedTile extends Tile{
	BedImageHandler bedTileImageHandler = new BedImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return bedTileImageHandler.returnImage();
