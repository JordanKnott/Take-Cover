...
import net.engine.resourceHandlers.tiles.floor.CarWindowImageHandler;


public class CarWindowTile extends Tile{
	CarWindowImageHandler concreteTileImageHandler = new CarWindowImageHandler();
