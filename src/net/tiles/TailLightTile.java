...
import net.engine.resourceHandlers.tiles.floor.TailLightImageHandler;


public class TailLightTile extends Tile{
	TailLightImageHandler concreteTileImageHandler = new TailLightImageHandler();
