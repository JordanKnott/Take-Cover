...
import net.engine.resourceHandlers.tiles.floor.DeepestDitchImageHandler;


public class DeepestDitchTile extends Tile{
	DeepestDitchImageHandler deepestDitchImageHandler = new DeepestDitchImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return deepestDitchImageHandler.returnImage();
	}
