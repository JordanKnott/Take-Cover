...
import net.engine.resourceHandlers.tiles.floor.HoodImageHandler;


public class HoodTile extends Tile{
	HoodImageHandler hoodImageHandler = new HoodImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return hoodImageHandler.returnImage();
	}
