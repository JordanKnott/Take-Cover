...
import net.engine.resourceHandlers.tiles.floor.HeadLightImageHandler;


public class HeadLightTile extends Tile{
	HeadLightImageHandler headLightImageHandler = new HeadLightImageHandler();
	...
	public Image returnTileImage(String cause){
				...
				return headLightImageHandler.returnImage();
	}
