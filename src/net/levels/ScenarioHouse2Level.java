...
public class ScenarioHouse2Level extends Level {
	...
	Tile WaterBottleTile = new WaterBottleTile();
	...
	Tile takeCoverTile = new TakeCoverTile(false, 5);
	Tile safeTakeCoverTile = new TakeCoverTile(true, 5);
	...
	public void populateGameBoard(GameBoard gameBoard){
		...
		CountdownThread cThread = new CountdownThread(5);
		Engine.inGame = true;
		cThread.start();
		Engine.mainPlayer().setPlayerCords(25, 25);;
		Engine.setPlayerStorageSpace(5);
		
		Engine.mainPlayer().setCurrentLevelID(5);
		//Grass
		...
		GameBoard.addTileObject(takeCoverTile, 30, 19);
		GameBoard.addTileObject(takeCoverTile, 30, 18);
		

		
		GameBoard.addTileObject(takeCoverTile, 26, 17);
		GameBoard.addTileObject(takeCoverTile, 27, 17);
		
		GameBoard.addTileObject(takeCoverTile, 26, 20);
		GameBoard.addTileObject(takeCoverTile, 27, 20);
		
		GameBoard.addTileObject(takeCoverTile, 53, 26);
		GameBoard.addTileObject(takeCoverTile, 53, 27);
		
		
		
		GameBoard.addTileObject(takeCoverTile, 58, 26);
		GameBoard.addTileObject(takeCoverTile, 59, 26);
		
		GameBoard.addTileObject(safeTakeCoverTile, 52, 20);
		GameBoard.addTileObject(safeTakeCoverTile, 53, 20);
		
		GameBoard.addTileObject(takeCoverTile, 62, 19);
		GameBoard.addTileObject(takeCoverTile, 63, 19);
		
		GameBoard.addTileObject(takeCoverTile, 55, 11);
		GameBoard.addTileObject(takeCoverTile, 55, 12);
	}
}
