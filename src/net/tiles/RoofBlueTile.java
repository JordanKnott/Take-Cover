...
import net.engine.resourceHandlers.tiles.floor.RoofBlueImageHandler;


public class RoofBlueTile extends Tile{
	RoofBlueImageHandler concreteTileImageHandler = new RoofBlueImageHandler();
